      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="h-full border-2 border-gray-200/50 dark:border-gray-800/50 hover:border-kaizen-crimson/30 hover:shadow-xl transition-all duration-300 dark:bg-kaizen-dark-gray">
