...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-32 bg-white dark:bg-black relative">
      {/* Zen paper texture */}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute left-8 top-20 w-px h-24 bg-stone-200 dark:bg-stone-800" />
              )}

              <div className="flex items-start gap-8 mb-16">
                {/* Step Number - Minimalist */}
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 border border-stone-300 dark:border-stone-700 flex items-center justify-center">
                    <span className="text-2xl font-light text-stone-400 dark:text-stone-600">
                      {step.number}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex-1 pt-2">
                  <div className="flex items-start gap-4 mb-4">
                    <step.icon className="h-6 w-6 text-stone-900 dark:text-stone-100 flex-shrink-0 mt-1" strokeWidth={1} />
                    <h3 className="text-2xl font-light text-stone-900 dark:text-stone-100 tracking-wide">
                      {step.title}
                    </h3>
                  </div>
                  <p className="text-stone-600 dark:text-stone-400 leading-loose font-light pl-10">
                    {step.description}
                  </p>
                </div>
              </div>
