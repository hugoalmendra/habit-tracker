        ...
        >
          <Card className="border-border/40 shadow-apple-lg">
            <CardContent className="pt-12 pb-8 text-center">
              ...
              <Link to="/login">
                <Button className="w-full h-14 rounded-xl bg-primary text-base font-semibold text-primary-foreground active:scale-[0.98] transition-all shadow-lg shadow-primary/25">
                  Back to Sign In
                </Button>
              </Link>
            </CardContent>
